...
export class Resources {
	...
	getResources(type?: string, search?: string): Observable<ResourcePage> {
		...
		return this.http.get<ResourcePage>(Backend.getBaseUrl() + '/resources', { params: params });
	}

	getResource(path: string): Observable<Resource> {
		return this.http.get<Resource>(Backend.getBaseUrl() + '/resources/' + path + '/info');
	}

	delete(path: string) {
		return this.http.delete<void>(Backend.getBaseUrl() + '/resources/' + path);
	}
	upload(type: string, files: File[]) {
		...
		return this.http.post<void>(Backend.getBaseUrl() + '/resources/upload/' + type, formData);
